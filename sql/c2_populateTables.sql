...
(`id`, `settings_difficulty`, `environment_startingPop`, `environment_virusSpreadRate`, `environment_virusSpreadTemp`)
VALUES (1, 1, 3, 5, 27.5);

INSERT INTO `user_schema`.`simulation`
(`id`, `settings_difficulty`, `environment_startingPop`, `environment_virusSpreadRate`, `environment_virusSpreadTemp`)
VALUES (2, 2, 4, 10, 30.0);

INSERT INTO `user_schema`.`simulation`
(`id`, `settings_difficulty`, `environment_startingPop`, `environment_virusSpreadRate`, `environment_virusSpreadTemp`)
VALUES (3, 3, 5, 2, 15.5);

INSERT INTO `user_schema`.`simulationparticipation`(`username`,`id`,`isOwner`) VALUES ('grace', 1, 1);
INSERT INTO `user_schema`.`simulationparticipation`(`username`,`id`,`isOwner`) VALUES ('troy', 1, 0);
INSERT INTO `user_schema`.`simulationparticipation`(`username`,`id`,`isOwner`) VALUES ('robert', 1, 0);
